      ...
      builder: (context, state) {
        ...
        body: Padding(
          ...
          child: ListView.separated(
            itemBuilder: (context, index) => SettingCubit.getInstance(context).notificationOptions[index],
            separatorBuilder: (context, index) => const SizedBox(height: 16,),
            itemCount: SettingCubit.getInstance(context).notificationOptions.length,
          ),
        ),
      );
      },
